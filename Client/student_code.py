...
def allocate(new_pokemons, agents, agentsPath):
    for i, p in enumerate(new_pokemons):
        print(agentsPath[0])
        # if p.isFinished is True or p.agentAssigned != -1:
        #     continue
        bestDist = float('inf')
        bestPath = []
        bestid = 0
...
while client.is_running() == 'true':
    ...
    allocate(game.pokemons, agents, agentsPath)
    # //////////////////////////////////////////////////////////
